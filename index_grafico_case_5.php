...
$stmt = $dbcon -> prepare("SELECT empenho.credor as credor, empenho.natureza as natureza,SUM(empenho.valor_empenho) as valor, SUM(empenho.saldo_empenho) as saldo, 
                            (SUM(empenho.valor_empenho) - SUM(empenho.saldo_empenho)) as diferenca, empenho.ano as ano FROM `empenho` as empenho
                            GROUP BY $eixoX
                            HAVING valor > saldo
                            ORDER BY $eixoY ASC
                            LIMIT 7");
